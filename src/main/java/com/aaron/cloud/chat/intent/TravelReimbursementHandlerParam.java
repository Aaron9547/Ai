...
import com.aaron.cloud.common.api.enums.IntentHandlerConfigValueKind;
import com.aaron.cloud.common.api.enums.IntentHandlerParamStorage;
...
public enum TravelReimbursementHandlerParam implements IntentHandlerParamSpec {
    ...
    COZE_DOMAIN(
            ...
            false,
            10,
            "如 https://api.coze.cn；留空用默认与系统参数",
