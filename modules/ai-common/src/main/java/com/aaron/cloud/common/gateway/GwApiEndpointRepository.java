...
public class GwApiEndpointRepository {
    ...
    public List<GwApiEndpoint> listAllEnabled() {
        return listPicker();
    }

    public List<GwApiEndpoint> listAll() {
        return mapper.selectList(
                Wrappers.<GwApiEndpoint>lambdaQuery().orderByAsc(GwApiEndpoint::getSortOrder).orderByAsc(GwApiEndpoint::getId));
    }
