...
const copyLabel = computed(() => {
  if (copied.value) {
    return t("views.markdown.codeBlock.copied");
  }
  if (copyFailed.value) {
    return t("views.markdown.codeBlock.copyFailed");
  }
  return t("views.markdown.codeBlock.copy");
});
...
<template>
  <div
    class="ai-code-block"
    role="group"
    :aria-label="t('views.markdown.codeBlock.aria', { lang: languageLabel })"
  >
