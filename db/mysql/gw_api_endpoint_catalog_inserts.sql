...
('/api/v1/admin/observability/mcp-traces', 'GET', 'MCP 跟踪链分页 / MCP trace chain page', '创始人可 filterTenantId', 1, 2071, UTC_TIMESTAMP(3), UTC_TIMESTAMP(3)),
('/api/v1/admin/observability/mcp-traces/*', 'GET', 'MCP 跟踪详情 / MCP trace detail', NULL, 1, 2072, UTC_TIMESTAMP(3), UTC_TIMESTAMP(3)),
('/api/v1/admin/observability/rag-hits', 'GET', 'RAG 命中链路分页 / RAG hit events page', '创始人可 filterTenantId', 1, 2073, UTC_TIMESTAMP(3), UTC_TIMESTAMP(3)),
('/api/v1/admin/observability/rag-hits/*', 'GET', 'RAG 命中批次详情 / RAG hit batch detail', NULL, 1, 2074, UTC_TIMESTAMP(3), UTC_TIMESTAMP(3)),
('/api/v1/admin/observability/conversations/*/traces', 'GET', '会话链路聚合 / Conversation traces', NULL, 1, 2075, UTC_TIMESTAMP(3), UTC_TIMESTAMP(3)),
('/api/v1/admin/rag-quality/assessments', 'GET', 'RAG 质量报告分页 / RAG quality reports page', '创始人可 filterTenantId', 1, 2076, UTC_TIMESTAMP(3), UTC_TIMESTAMP(3)),
('/api/v1/admin/rag-quality/assessments', 'POST', '提交 RAG 质量评测 / Submit RAG quality assessment', '异步 QUEUED', 1, 2077, UTC_TIMESTAMP(3), UTC_TIMESTAMP(3)),
('/api/v1/admin/rag-quality/assessments/*', 'GET', 'RAG 质量报告详情 / RAG quality report detail', NULL, 1, 2078, UTC_TIMESTAMP(3), UTC_TIMESTAMP(3)),
('/api/v1/admin/rag-ltr/train', 'POST', '触发 RAG LTR 训练 / Trigger RAG LTR training', '入队 RAG_LTR_TRAIN', 1, 2080, UTC_TIMESTAMP(3), UTC_TIMESTAMP(3)),
('/api/v1/admin/rag-ltr/status', 'GET', 'RAG LTR 模型状态 / RAG LTR model status', NULL, 1, 2081, UTC_TIMESTAMP(3), UTC_TIMESTAMP(3)),
-- ---------- API：用户 ----------
